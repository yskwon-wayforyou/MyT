...
| A13 | BT Phone Key 자동 실행 | 연결 시 Gauge 포그라운드 | ● | Doze/OEM 배터리 예외 안내, 실패 복구 UX, 회귀 자동화 | W2 |
| A14–A15 | 과속·구간단속 | L1–L3 경고, 평균속도 | ● | POI OTA SLA, 오탐/미탐 로그, 지도 마커·매칭 품질, 6,000+건 동기화 UX | W2 |
...
| Q-DRV-01 | 운전 중 조작 최소화 | 큰 글씨·최소 탭·고지 | ◐ | Play 운전 고지, 첫 실행/Gauge 진입 배너 | W2, W5 |
