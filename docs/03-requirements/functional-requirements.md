...
| FR-C07 | Fleet API vehicle_data 폴링 (주행 2s, 주차 30s) | 1 | P0 |
...
| FR-CH02 | 충전 비용 계산 (Time-of-Use) | 2 | P2 |
...
| FR-CH08 | Supercharger 비용/영수증 | 2 | P3 |
| FR-CH09 | 충전소 지도 | 2 | P3 |
...
| FR-P04 | Apple Watch 앱 (SOC, 잠금, 클라이-mate) | 2 | P2 |
| FR-P05 | Wear OS 앱 | 2 | P3 |
